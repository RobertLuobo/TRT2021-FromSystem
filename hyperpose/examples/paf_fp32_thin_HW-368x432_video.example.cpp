...
DEFINE_string(model_file, "../data/models/openpose-thin-V2-HW=368x432.onnx.trt", "Path to uff model.");
DEFINE_int32(input_height, 368, "Height of input image.");
DEFINE_int32(input_width, 432, "Width of input image.");
...
DEFINE_string(output_video, "thin_output_video_fp32_paf.avi", "The name of output video.");
...
int main(int argc, char** argv)
{
    ...
    std::cout << "openpose-thin-V2-HW=368x432.onnx openpose-thin-V2-HW=368x432.onnx.trt  fp32\n";
