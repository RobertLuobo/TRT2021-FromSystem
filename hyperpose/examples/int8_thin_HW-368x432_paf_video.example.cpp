...
// Model flags
//DEFINE_string(model_file,"../data/models/lopps-resnet50-V2-HW=368x432.onnx" , "Path to uff model.");
//DEFINE_int32(input_height, 368, "Height of input image.");
//DEFINE_int32(input_width, 432, "Width of input image.");
//
DEFINE_string(model_file,"/hyperpose/conver_to_trt/models_save/hyperpose_thin_368x432_int8.trt" , "Path to uff model.");
//DEFINE_string(model_file,"../data/models/openpose-coco-V2-HW=368x656.onnx" , "Path to uff model.");
//DEFINE_int32(input_height, 368, "Height of input image.");
//DEFINE_int32(input_width, 656, "Width of input image.");

//DEFINE_string(model_file, "../data/models/openpose-thin-V2-HW=368x432.onnx", "Path to uff model.");
DEFINE_int32(input_height, 368, "Height of input image.");
DEFINE_int32(input_width, 432, "Width of input image.");
...
DEFINE_string(output_video, "thin_paf_output_video_int8.avi", "The name of output video.");
...
int main(int argc, char** argv)
{
    ...
    std::cout << "openpose-thin-V2-HW=368x432.onnx  hyperpose_thin_368x432_int8.trt  int8\n";
