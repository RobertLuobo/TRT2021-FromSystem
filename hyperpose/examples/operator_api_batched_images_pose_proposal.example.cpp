...
// Model flags
DEFINE_string(model_file, "../data/models/ppn-resnet50-V2-HW=384x384.onnx.trt", "Path to uff model.");
...
int main(int argc, char** argv)
{
    ...
    auto beg = clk_t::now();
    {
        ...
        std::cout << "ppn-resnet50-V2-HW=384x384.onnx.trt  fp32 \n  ";
        ...
        for (size_t i = 0; i < batch.size(); ++i) {
            ...
            cv::imwrite("ppn_fp32_output_" + std::to_string(i) + ".png", batch[i]);
        }
    }
}
