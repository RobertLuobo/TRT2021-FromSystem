...
int main(int argc, char** argv)
{
    ...
    auto beg = clk_t::now();
    {
        ...
        std::cout << batch.size() << " images got processed. FPS = "
       	...
       	std::cout << "openpose-thin-V2-HW=368x432.onnx hyperpose_thin_368x432_int8.trt  int8 " << "batchsize:" << batch.size() << "\n";
        for (size_t i = 0; i < batch.size(); ++i) {
            ...
            cv::imwrite("thin_paf_output_int8_" + std::to_string(i) + ".png", batch[i]);
        }
    }
}
