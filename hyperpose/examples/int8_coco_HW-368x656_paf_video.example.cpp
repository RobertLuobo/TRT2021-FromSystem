...
DEFINE_string(output_video, "output_video_int8_paf.avi", "The name of output video.");
...
int main(int argc, char** argv)
{
    ...
    std::cout << "openpose-coco-V2-HW=368x656.onnx hyperpose_coco_368x656_int8.trt   int8\n";
