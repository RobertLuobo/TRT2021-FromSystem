...
int main(int argc, char** argv)
{
    ...
    auto beg = clk_t::now();
    {
        ...
        std::cout << batch.size() << " images got processed. FPS = "
       	...
       	std::cout << "openpose-coco-V2-HW=368x656.onnx openpose-thin-V2-HW=368x432.onnx.trt   fp32 " << "batchsize:" << batch.size() << "\n";
        for (size_t i = 0; i < batch.size(); ++i) {
            ...
            cv::imwrite("thin_output_fp32_paf_" + std::to_string(i) + ".png", batch[i]);
        }
    }
}
