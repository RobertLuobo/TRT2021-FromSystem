...
DEFINE_string(model_file,"../data/models/openpose-coco-V2-HW=368x656.onnx.trt" , "Path to uff model.");
DEFINE_int32(input_height, 368, "Height of input image.");
...
//DEFINE_string(output_video, "output_video_fp32_lopps.avi", "The name of output video.");
DEFINE_string(output_video, "coco_paf_fp32_output_video.avi", "The name of output video.");
...
int main(int argc, char** argv)
{
    ...
    std::cout << "openpose-coco-V2-HW=368x656.onnx fp32\n";
