...
// Model flags
DEFINE_string(model_file, "/hyperpose/conver_to_trt/models_save/hyperpose_ppn_384x384_int8.trt", "Path to uff model.");
...
DEFINE_string(output_video, "ppn_fp32_output_video.avi", "The name of output video.");
...
int main(int argc, char** argv)
{
    ...
    std::cout << "hyperpose_ppn_384x384_int8.trt  int8 \n  ";
